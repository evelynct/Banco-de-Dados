...
INSERT INTO escola.curso(id_curso, nome, descricao, carga_horaria, total_aulas, ano_criacao)
 VALUES
	(1,'HTML5','Curso de HTML5',40,37,2014),
    (2,'Algoritmos','Lógica de Programação',20,15,2014),
    (3,'Photoshop5','Dicasde Photoshop CC',10,8,2014),
    ...
    (11,'Responsividade','Cursode Responsividade',30,15,2018),
    ...
    (22,'Premiere','Curso de Edição de Vídeoscom Premiere',20,10,2017),
    (23,'After Effects','Curso de Efeitos em Vídeos com After Effects',20,10,2018),
    (24,'WordPress','Curso de Criação deSites com WordPress',60,30,2019),
    (25,'Joomla','Curso de Criação de Sites com Joomla',60,30,2019),
    (26,'Magento','Curso de Criação de LojasVirtuais com Magento',50,25,2019),
    (27,'Modelagem de Dados','Curso de Modelagem de Dados',30,12,2020),
    (28,'HTML4','Curso Básico de HTML, versão4.0',20,9,2010),
...
INSERT INTO escola.aluno (id_aluno, nome, profissao, data_nascimento, sexo, peso, altura, nacionalidade) 
 VALUES 
	(1,'Daniel Morais','Auxiliar Administrat','1984-01-02','M',78.50,1.83,'Brasil'),
	(2,'TalitaNascimento','Farmacêutico','1999-12-30','F',55.20,1.65,'Portugal'),
    ...
    (5,'LeilaMartins','Farmacêutico','1975-04-22','F',99.00,2.15,'Brasil'),
    ...
    (20,'MarcosDissotti','Empreendedor','2010-01-01','M',53.79,1.54,'Portugal'),
    ...
    (29,'TiagoUlisses','Dentista','1993-04-22','M',150.30,2.35,'Brasil'),
    ...
    (36,'Robson Rodolpho','AuxiliarAdministrat','2000-08-08','M',110.10,1.76,'Brasil'),
    (37,'Daniele Moledo','Empreendedor','2006-08-11','F',101.30,1.99,'Brasil'),
    (38,'NetoSophiate','Ator','1996-05-17','M',59.28,1.65,'Portugal'),
    ...
    (47,'BrunoMiltersteiner','Dentista','1986-02-19','M',77.45,1.65,'Alemanha'),
    ...
    (52,'Bruna Santos','AuxiliarAdministrat','1991-12-01','F',76.30,1.45,'Canadá'),
    (53,'André Vitebo','Médico','1970-07-01','M',44.11,1.55,'Brasil'),
    (54,'AndreSantini','Programador','1991-08-15','M',66.00,1.76,'Itália'),
...
-- ---------------------------------------------
/* Apresente uma query que retorne uma consulta com todos os homens que trabalham 
comopro gramadores e dentistas, ordenando tais informações de forma ascendente, 
considerandoo nome do aluno;  */

SELECT id_aluno, nome, profissao
FROM aluno
WHERE profissao IN ('Programador', 'Dentista') AND sexo = 'M'
ORDER BY nome ASC;

-- ------------------------------------------
/* Apresente uma query que retorne uma consulta que traga todas as informações 
das mulheres que nasceram em Portugal e que tem seu nome iniciado pela letra T */

SELECT *
FROM aluno
WHERE sexo = 'F' and nacionalidade = 'Portugal' and nome LIKE  'T%'; 

-- ------------------------------------------
/* Apresente uma query que retorne uma consulta com o nome e nacionalidade de todos
 os homens que têm Silva no nome, data de nascimento maior ou igual a 01/01/1990 e
 pesammenos de 100 kg; */

SELECT nome, nacionalidade
FROM aluno
WHERE sexo = 'M' AND nome LIKE '%Silva%' AND data_nascimento >= '1990-01-01' AND peso < 100;

-- ------------------------------------------
/* Considerando a carga horária dos cursos, apresente uma query onde sejam
 selecionados os registros onde os cursos têm carga horária maior que 30 horas 
e menor ou igual a 60 horas.Caso se utilize o comando o between existe alguma 
diferença? */

SELECT *
FROM curso
WHERE carga_horaria > 30 AND carga_horaria <= 60;
